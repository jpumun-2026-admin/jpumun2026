...
class _RegisterInstituteState extends State<RegisterInstitute> {
  ...
  final List<_DelegateFormData> _delegates = [
    _DelegateFormData(),
  ];
  ...
  void _removeDelegate(int index) {
    if (_delegates.length == 1) {
      _showMessage(
        'At least one delegate must be added.',
      );
      return;
    }
  ...
  void _proceed() {
    ...
    // ----------------------------------------------------------
    // Validate delegate committee preferences
    // ----------------------------------------------------------
    ...
    for (int i = 0; i < _delegates.length; i++) {
      ...
      if (delegate.committeePreference1 ==
          delegate.committeePreference2) {
        _showMessage(
    ...
    final data = {
      ...
      'faculty_advisor': {
        'name':
            _facultyAdvisorNameController.text.trim(),
        'contact':
            _facultyAdvisorContactController.text.trim(),
      },

      'head_delegate': {
        'name':
            _headDelegateNameController.text.trim(),
        'contact':
            _headDelegateContactController.text.trim(),
      },

      'approximate_delegation_size':
          int.tryParse(
      ...
      'delegates': _delegates
          .map(
            (delegate) => {
              'full_name':
                  delegate.nameController.text.trim(),
              'email':
                  delegate.emailController.text.trim(),
              'contact':
                  delegate.contactController.text.trim(),
              'mun_experience': delegate
                  .munExperienceController.text
                  .trim(),
              'committee_preference_1':
                  delegate.committeePreference1,
    ...
    // TODO:
    // Submit institutional registration to Google Sheets.
    //
      ...
      children: [
        ...
        if (isMobile) ...[
          ...
          _FormFieldBlock(
            ...
            child: _buildTextField(
              controller:
                  _facultyAdvisorContactController,
              hint: '+91 XXXXX XXXXX',
        ...
        if (isMobile) ...[
          ...
          _FormFieldBlock(
            ...
            child: _buildTextField(
              controller:
                  _headDelegateContactController,
              hint: '+91 XXXXX XXXXX',
              keyboardType: TextInputType.phone,
              validator: _phoneValidator,
            ),
        ...
        _FormFieldBlock(
          ...
          child: _buildTextField(
            controller:
                _delegationSizeController,
            hint:
                'Enter approximate number of delegates',
            keyboardType: TextInputType.number,
            validator:
                _delegationSizeValidator,
            inputFormatters: [
      ...
      child: Column(
        ...
        children: [
          ...
          _FormFieldBlock(
            ...
            child: _buildTextField(
              controller: delegate
                  .munExperienceController,
              hint:
                  'Tell us about previous MUN experience',
              maxLines: 4,
            ),
          ),
          ...
          if (isMobile) ...[
            _FormFieldBlock(
              label:
                  'Portfolio / Country Preference 01',
              child: _buildTextField(
                controller: delegate
                    .portfolioPreference1Controller,
                hint:
                    'Enter preferred portfolio / country',
                validator: _required,
              ),
            ),
            ...
            _FormFieldBlock(
              label:
                  'Portfolio / Country Preference 02',
              child: _buildTextField(
                controller: delegate
                    .portfolioPreference2Controller,
                hint:
...
class _DelegateFormData {
  ...
  final portfolioPreference1Controller =
      TextEditingController();

  final portfolioPreference2Controller =
      TextEditingController();
...
class _AddDelegateButton extends StatefulWidget {
  ...
  @override
  State<_AddDelegateButton> createState() =>
      _AddDelegateButtonState();
}

class _AddDelegateButtonState
    extends State<_AddDelegateButton> {
